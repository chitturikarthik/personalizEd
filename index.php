						...
						<span class="thumb-info thumb-info-no-borders thumb-info-no-borders thumb-info-lighten thumb-info-bottom-info thumb-info-bottom-info-dark thumb-info-bottom-info-show-more thumb-info-no-zoom">
							<span class="thumb-info-wrapper overlay overlay-show overlay-op-8">
								...
								<span class="thumb-info-title bg-transparent mb-4 ps-4 ms-2">
									<span class="thumb-info-type font-weight-light text-1 line-height-1 opacity-8">Most loved content by students</span>
									<span class="thumb-info-inner font-weight-bold text-4 line-height-4">Communication By Rishitha</span>
					...
					<div class="col-lg-4 px-lg-1 mb-3 appear-animation" data-appear-animation="fadeInDownShorter" data-appear-animation-delay="600">
						<span class="thumb-info thumb-info-no-borders thumb-info-no-borders thumb-info-lighten thumb-info-bottom-info thumb-info-bottom-info-dark thumb-info-bottom-info-show-more thumb-info-no-zoom">
							<span class="thumb-info-wrapper overlay overlay-show overlay-op-8">
								...
								<span class="thumb-info-title bg-transparent mb-4 ps-4 ms-2">
									<span class="thumb-info-type font-weight-light text-1 line-height-1 opacity-8">See this useful content on Blender</span>
									<span class="thumb-info-inner font-weight-bold text-4 line-height-4">Graphic Design by Tejesh</span>
									<span class="thumb-info-show-more-content pe-3">
										<p class="mb-0 text-1 line-height-9 pe-5 pb-3 me-5 mb-3 mt-2">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus blandit massa enim. Nullam id varius nunc. Vivamus bibendum magna ex.</p>
										<a href="#" class="d-inline-flex align-items-center btn btn-light text-color-dark font-weight-bold px-2 btn-py-1 text-1 rounded"><span class="text-2 py-1 ps-2">LEARN MORE</span> <i class="fa fa-arrow-right ms-2 me-2 ps-4 text-3"></i></a>
									</span>
				...
				<div class="row justify-content-md-center py-4 mt-3">
					...
					<div class="col-md-8 col-lg-5">
						...
						<div class="row">
							...
							<div class="col-6 col-md-4 mb-5 mb-lg-0">
								<ul class="list list-icons list-icons-sm">
									<li><i class="fas fa-angle-right"></i><a href="blog-post.html" class="link-hover-style-1 ms-1"> Blog</a></li>
									<li><i class="fas fa-angle-right"></i><a href="page-coming-soon.html" class="link-hover-style-1 ms-1"> Coming Soon</a></li>
									<li><i class="fas fa-angle-right"></i><a href="page-careers.html" class="link-hover-style-1 ms-1"> Careers</a></li>
								</ul>
							</div>
							<div class="col-6 col-md-4 mb-5 mb-lg-0">
								<ul class="list list-icons list-icons-sm">
				...
				<div class="container py-2">
					<div class="row py-4">
						<div class="col d-flex align-items-center justify-content-center mb-4 mb-lg-0">
							<p class="font-weight-semibold text-3">© Copyright 2023. All Rights Reserved.</p>
						</div>
					</div>
				</div>
			</div>
